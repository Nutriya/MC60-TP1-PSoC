// ======================================================================
// Partie_3.v generated from TopDesign.cysch
// 12/03/2024 at 15:48
...
module ADC_SAR_SEQ_P4_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("5feeae74-29cd-4c77-b197-90223a41fed7/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__PIN_ANALOGIQUE_net;
	wire [0:0] tmpFB_0__PIN_ANALOGIQUE_net;
	wire [0:0] tmpIO_0__PIN_ANALOGIQUE_net;
	wire [0:0] tmpINTERRUPT_0__PIN_ANALOGIQUE_net;
	electrical [0:0] tmpSIOVREF__PIN_ANALOGIQUE_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_ANALOGIQUE
		 (.oe(tmpOE__PIN_ANALOGIQUE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_ANALOGIQUE_net[0:0]}),
		  .analog({Net_128}),
		  .io({tmpIO_0__PIN_ANALOGIQUE_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_ANALOGIQUE_net),
		  .interrupt({tmpINTERRUPT_0__PIN_ANALOGIQUE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_ANALOGIQUE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("9f48dd01-1a66-4db1-9b36-32a749e8f321"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__PIN_GROUND_ADC_net;
	wire [0:0] tmpFB_0__PIN_GROUND_ADC_net;
	wire [0:0] tmpIO_0__PIN_GROUND_ADC_net;
	wire [0:0] tmpINTERRUPT_0__PIN_GROUND_ADC_net;
	electrical [0:0] tmpSIOVREF__PIN_GROUND_ADC_net;

	cy_psoc3_pins_v1_10
		#(.id("bbd7be7c-9170-4acc-b3ff-fcecf808ade9"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_GROUND_ADC
		 (.oe(tmpOE__PIN_GROUND_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_GROUND_ADC_net[0:0]}),
		  .analog({Net_18}),
		  .io({tmpIO_0__PIN_GROUND_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_GROUND_ADC_net),
		  .interrupt({tmpINTERRUPT_0__PIN_GROUND_ADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_GROUND_ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__PIN_PWM_SORTIE_net;
	wire [0:0] tmpFB_0__PIN_PWM_SORTIE_net;
	wire [0:0] tmpIO_0__PIN_PWM_SORTIE_net;
	wire [0:0] tmpINTERRUPT_0__PIN_PWM_SORTIE_net;
	electrical [0:0] tmpSIOVREF__PIN_PWM_SORTIE_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_PWM_SORTIE
		 (.oe(tmpOE__PIN_PWM_SORTIE_net),
		  .y({Net_156}),
		  .fb({tmpFB_0__PIN_PWM_SORTIE_net[0:0]}),
		  .io({tmpIO_0__PIN_PWM_SORTIE_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_PWM_SORTIE_net),
		  .interrupt({tmpINTERRUPT_0__PIN_PWM_SORTIE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_PWM_SORTIE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
